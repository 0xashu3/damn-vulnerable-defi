...
describe("[Challenge] Side entrance", function () {
  ...
  it("Exploit", async function () {
    ...
    const SideEntranceLenderPoolAttackFactory = await ethers.getContractFactory(
      "SideEntranceLenderPoolAttack",
      attacker
    );
    const attackContract = await SideEntranceLenderPoolAttackFactory.deploy(
      this.pool.address
    );
