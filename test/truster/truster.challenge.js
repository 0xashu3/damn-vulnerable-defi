...
describe("[Challenge] Truster", function () {
  ...
  it("Exploit", async function () {
    ...
    const trustExploiterFactory = await ethers.getContractFactory(
      "TrusterExploit",
      attacker
    );
    const trustExploiter = await trustExploiterFactory.deploy();
    await trustExploiter.deployed();
    console.log("Trust Exploiter deployed at ", trustExploiter.address);
    await trustExploiter
      .connect(attacker)
